...
import com.example.mobilephoneplayer.view.VitamioVideoView;
...
public class VitamioVideoPlayerActivity extends Activity implements View.OnClickListener {
    ...
    *//**
    ...
    private void findViews() {
        ...
        videoView = (VitamioVideoView) findViewById(videoview);
    ...
    *//**
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_NET_SPEAD:
                    String netSpead = utils.showNetSpeed(VitamioVideoPlayerActivity.this);
                    //不为空
                ...
                case HIDE_MEDIA_CONTROLLER:
                    ...
                    break;
                case PROGRESS:
                    int currentPositoin = (int) videoView.getCurrentPosition();
                    //设置视频更新
...
//        videoView.setMediaController(new MediaController(this));
    ...
    *//**
    ...
    private void showErrorDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("提醒")
                .setMessage("播放器播放出错了，请检查视频是否损坏，或者网络中断")
